...
PropertyView *
MorphOperatorView::add_property_view (const std::string& identifier, Widget *parent, OperatorLayout& layout)
{
  auto pv = new PropertyView (*m_op->property (identifier), parent, layout);
