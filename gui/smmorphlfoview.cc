...
MorphLFOView::on_frequency_changed (int new_value)
{
  ...
  frequency_label->setText (string_locale_printf ("%.3f Hz", frequency).c_str());
...
MorphLFOView::on_depth_changed (int new_value)
{
  ...
  depth_label->setText (string_locale_printf ("%.1f %%", depth * 100).c_str());
...
MorphLFOView::on_center_changed (int new_value)
{
  ...
  center_label->setText (string_locale_printf ("%.2f", center).c_str());
...
MorphLFOView::on_start_phase_changed (int new_value)
{
  ...
  start_phase_label->setText (string_locale_printf ("%.2f", start_phase).c_str());
