  ...
  morph_output (morph_output)
{
  ...
  // Unison Detune
  pv_unison_detune = xprop (grid_layout, 8, "Detune", 0.5, 50, 10, "%.1f Cent", morph_output, &MorphOutput::unison_detune, &MorphOutput::set_unison_detune);
...
{
  unison_voices_title->setVisible (morph_output->chorus());
  unison_voices_label->setVisible (morph_output->chorus());
  unison_voices_slider->setVisible (morph_output->chorus());
  pv_unison_detune.setVisible (morph_output->chorus());
