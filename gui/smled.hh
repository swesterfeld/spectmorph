...
class Led : public QWidget
{
  ...
  public:
     ...
     * @short Constructor
     */
    explicit Led( const QColor &color, QWidget *parent = 0 );
     ...
     * @short Constructor
     */
    Led( const QColor& color, Led::State state, Led::Look look, Led::Shape shape,
          QWidget *parent = 0 );
     ...
     *
     * The LED is shown with Color when in the Led::On state
     * or with the darken Color (@see setDarkFactor) in Led::Off
     * state.
     *
     ...
     * becomes lighter in Led::Off state.
     *
     * Defaults to 300.
     *
     * @see QColor
