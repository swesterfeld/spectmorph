...
class NoiseDecoder
{
  ...
  void apply_window_hanning (float *spectrum, float *fft_buffer);
...
public:
  ...
  enum OutputMode { REPLACE, ADD, FFT_SPECTRUM_BH92, FFT_SPECTRUM_HANNING, DEBUG_UNWINDOWED, DEBUG_NO_OUTPUT };
