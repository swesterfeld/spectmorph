...
class NoiseDecoder
{
  ...
  void apply_window_hanning_overwrite (float *spectrum, float *fft_buffer);
...
public:
  ...
  enum OutputMode { REPLACE, ADD, ADD_SPECTRUM_BH92, SET_SPECTRUM_HANNING, DEBUG_UNWINDOWED, DEBUG_NO_OUTPUT };
